...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Check AI API status
    const aiStatus = {
      hasOpenAI: !!process.env.LOOKUP_OPENAI_API_KEY,
      hasNVIDIA: !!process.env.NVIDIA_API_KEY,
      hasAnyAI: !!(process.env.LOOKUP_OPENAI_API_KEY || process.env.NVIDIA_API_KEY),
      status: (process.env.LOOKUP_OPENAI_API_KEY || process.env.NVIDIA_API_KEY) ? 'online' : 'offline'
    };
